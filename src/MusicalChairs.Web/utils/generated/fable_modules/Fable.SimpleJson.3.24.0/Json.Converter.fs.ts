...
import { toText, join, fromBase64String, printf, toFail, substring } from "../fable-library-ts.4.24.0/String.js";
...
import { getBytesInt32, toInt64 as toInt64_1 } from "../fable-library-ts.4.24.0/BitConverter.js";
...
export function Convert_flattenMap(_arg: Convert_InternalMap_$union): FSharpList<[string, Json_$union]> {
    switch (_arg.tag) {
        case /* MapOne */ 1:
            return singleton([_arg.fields[0], _arg.fields[1]] as [string, Json_$union]);
        case /* MapNode */ 2: {
...
export function Convert_flattenFable3Lists(linkedList: FSharpMap<string, Json_$union>): FSharpList<Json_$union> {
    return toList<Json_$union>(delay<Json_$union>((): Iterable<Json_$union> => {
        let matchValue: Option<Json_$union>;
        return append<Json_$union>((matchValue = tryFind<string, Json_$union>("head", linkedList), (matchValue == null) ? (empty_1<Json_$union>()) : singleton_1<Json_$union>(value_91(matchValue))), delay<Json_$union>((): Iterable<Json_$union> => {
...
export function Convert_fromJsonAs(input_mut: Json_$union, typeInfo_mut: TypeInfo_$union): any {
    let foundCase: UnionCase, foundCase_1: UnionCase, testExpr: TypeInfo_$union[], values_8: FSharpList<[string, Json_$union]>, tree: FSharpList<Json_$union>, tree_1: FSharpMap<string, Json_$union>, value: string, value_1: string, optionalTypeDelayed: (() => TypeInfo_$union), getTypes: (() => [UnionCase[], any]), optionalTypeDelayed_1: (() => TypeInfo_$union), optionalTypeDelayed_2: (() => TypeInfo_$union), optionalTypeDelayed_3: (() => TypeInfo_$union), optionalTypeDelayed_4: (() => TypeInfo_$union);
    Convert_fromJsonAs:
    while (true) {
        ...
        switch (input.tag) {
            case /* JString */ 1: {
                switch (typeInfo.tag) {
                    ...
                    case /* Option */ 27: {
                        if ((optionalTypeDelayed = typeInfo.fields[0], !equals(input, Json_JNull()))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                    ...
                    case /* Union */ 40: {
                        if ((getTypes = typeInfo.fields[0], Convert_isQuoted(input.fields[0]))) {
                            matchResult = 50;
            ...
            case /* JBool */ 2: {
                switch (typeInfo.tag) {
                    ...
                    case /* Option */ 27: {
                        if ((optionalTypeDelayed_1 = typeInfo.fields[0], !equals(input, Json_JNull()))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            case /* JObject */ 5: {
                switch (typeInfo.tag) {
                    ...
                    case /* Option */ 27: {
                        if ((optionalTypeDelayed_2 = typeInfo.fields[0], !equals(input, Json_JNull()))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            case /* JArray */ 4: {
                switch (typeInfo.tag) {
                    ...
                    case /* Option */ 27: {
                        if ((optionalTypeDelayed_3 = typeInfo.fields[0], !equals(input, Json_JNull()))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            default:
                switch (typeInfo.tag) {
                    ...
                    case /* Option */ 27: {
                        if ((optionalTypeDelayed_4 = typeInfo.fields[0], !equals(input, Json_JNull()))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
        ...
        switch (matchResult) {
            ...
            case 26: {
                const patternInput_1: [TypeInfo_$union, any] = getElemType!();
                return value_28!;
            }
            case 27: {
                ...
                switch (matchResult_1) {
                    case 0: {
                        ...
                        if (_arg != null) {
                            if ((foundCase = value_91(_arg), (foundCase.CaseTypes.length === 1) && Convert_arrayLike(item_1(0, foundCase.CaseTypes)))) {
                                ...
                                return makeUnion(foundCase_2.Info, [Convert_fromJsonAs(Json_JArray(values_1!), item_1(0, foundCase_2.CaseTypes))]);
                            }
                                ...
                                return makeUnion(foundCase_3.Info, [Convert_fromJsonAs(Json_JArray(values_1!), item_1(0, foundCase_3.CaseTypes))]);
                            }
                            else {
                                ...
                                return makeUnion(foundCase_4.Info, map_2<[TypeInfo_$union, Json_$union], any>((tupledArg: [TypeInfo_$union, Json_$union]): any => Convert_fromJsonAs(tupledArg[1], tupledArg[0]), zip<TypeInfo_$union, Json_$union>(foundCase_4.CaseTypes, toArray<Json_$union>(values_1!))));
                            }
                        }
                        else {
                            const expectedCases: string = join(", ", map_2<UnionCase, string>((case$_1: UnionCase): string => toText(printf(" \'%s\' "))(case$_1.CaseName), cases));
                    ...
                    case 1: {
                        ...
                        switch (matchResult_2) {
                            ...
                            default: {
                                const expectedCases_1: string = join(", ", map_2<UnionCase, string>((case$_3: UnionCase): string => toText(printf(" \'%s\' "))(case$_3.CaseName), cases));
                    ...
                    default:
                        if ((containsKey<string, Json_$union>("tag", values) && containsKey<string, Json_$union>("fields", values)) && (count<string, Json_$union>(values) === 2)) {
                            ...
                            switch (matchResult_3) {
                                case 0: {
                                    ...
                                    return makeUnion(foundCase_5.Info, mapIndexed<Json_$union, any>((index: int32, value_48: Json_$union): any => Convert_fromJsonAs(value_48, item_1(index, foundCase_5.CaseTypes)), toArray<Json_$union>(fieldValues!)));
                                }
                                default: {
                            ...
                            const foundDiscriminatorKey: Option<string> = tryFind_2<string>((keyword: string): boolean => containsKey<string, Json_$union>(keyword, values), ofArray(["__typename", "$typename", "$type"]));
                            if (foundDiscriminatorKey != null) {
                                const discriminatorValueJson: Json_$union = find<string, Json_$union>(value_91(foundDiscriminatorKey), values);
                                if (discriminatorValueJson.tag === /* JString */ 1) {
                                    ...
                                    if (foundUnionCase != null) {
                                        ...
                                        return makeUnion(case$_5.Info, [Convert_fromJsonAs(Json_JObject(values), item_1(0, case$_5.CaseTypes))]);
                                    }
                                    else {
                            ...
                            const unexpectedJson: string = JSON.stringify(matchValue_3);
            ...
            case 49: {
                ...
                switch (matchResult_4) {
                    case 0:
                        return toInt64_1(concat<uint8>([Array.from(getBytesInt32(~~low!)), Array.from(getBytesInt32(~~high!))]), 0);
                    default:
            ...
            case 50: {
                ...
                if (_arg_3 == null) {
                    const expectedCases_2: string = join(", ", map_2<UnionCase, string>((case$_7: UnionCase): string => toText(printf(" \'%s\' "))(case$_7.CaseName), caseTypes));
                    const arg_33: string = name_2(patternInput_3[1]);
            ...
            case 51: {
                ...
                if (_arg_4 == null) {
                    const expectedCases_3: string = join(", ", map_2<UnionCase, string>((case$_9: UnionCase): string => toText(printf(" \'%s\' "))(case$_9.CaseName), caseTypes_1));
                    const arg_37: string = name_2(patternInput_4[1]);
            ...
            case 53: {
                ...
                switch (matchResult_5) {
                    case 0: {
                        ...
                        if (_arg_5 == null) {
                            const expectedCases_4: string = join(", ", map_2<UnionCase, string>((case$_11: UnionCase): string => toText(printf(" \'%s\' "))(case$_11.CaseName), cases_1));
                            const arg_41: string = name_2(patternInput_5[1]);
                    ...
                    case 1: {
                        ...
                        if (_arg_6 != null) {
                            ...
                            return makeUnion(caseInfo_4, map_2<[TypeInfo_$union, Json_$union], any>((tupledArg_1: [TypeInfo_$union, Json_$union]): any => Convert_fromJsonAs(tupledArg_1[1], tupledArg_1[0]), zip<TypeInfo_$union, Json_$union>(types, toArray<Json_$union>(values_3!))));
                        }
                        else {
                            const expectedCases_5: string = join(", ", map_2<UnionCase, string>((_arg_7: UnionCase): string => _arg_7.CaseName, cases_1));
            ...
            case 56: {
                ...
                return map_3<Json_$union, any>((value_59: Json_$union): any => Convert_fromJsonAs(value_59, elementType_2), Convert_flattenFable3Lists(linkedList!));
            }
            case 57: {
            ...
            case 58: {
                ...
                return map_3<Json_$union, any>((value_63: Json_$union): any => Convert_fromJsonAs(value_63, elementType_4), values_7!);
            }
            case 59:
                return map_2<[TypeInfo_$union, Json_$union], any>((tupledArg_2: [TypeInfo_$union, Json_$union]): any => Convert_fromJsonAs(tupledArg_2[1], tupledArg_2[0]), zip<TypeInfo_$union, Json_$union>(tupleTypesDelayed!(), toArray<Json_$union>(array_12!)));
            case 60: {
                ...
                return makeRecord(recordType, (values_8 = toList_1<string, Json_$union>(dict_1!), map_2<RecordField, any>((_arg_8: RecordField): any => {
                    ...
                    const _arg_9: Option<[string, Json_$union]> = tryFind_2<[string, Json_$union]>((tupledArg_3: [string, Json_$union]): boolean => (fieldName === tupledArg_3[0]), values_8);
                    if (_arg_9 == null) {
                        if (fieldType.tag === /* Option */ 27) {
                            ...
                            const arg_53: string = join(", ", map_2<RecordField, string>((_arg_10: RecordField): string => {
                                ...
                                if (_arg_10.FieldType.tag === /* Option */ 27) {
            ...
            case 61: {
                ...
                const pairs: FSharpList<any> = toList<any>(delay<any>((): Iterable<any> => collect<Json_$union, Iterable<any>, any>((keyValuePair: Json_$union): Iterable<any> => {
                    ...
                    return singleton_1<any>(Convert_fromJsonAs(keyValuePair, TypeInfo_Tuple((a = [keyType, patternInput_7[1]], (): TypeInfo_$union[] => a))));
                }, tuples!)));
                switch (keyType.tag) {
                    case /* Int32 */ 6:
                    case /* String */ 2:
            ...
            case 62: {
                ...
                const pairs_1: FSharpList<any> = toList<any>(delay<any>((): Iterable<any> => collect<Json_$union, Iterable<any>, any>((keyValuePair_1: Json_$union): Iterable<any> => singleton_1<any>(Convert_fromJsonAs(keyValuePair_1, TypeInfo_Tuple((): TypeInfo_$union[] => [keyType_1, patternInput_8[1]]))), tuples_1!)));
            ...
            case 63: {
                ...
                const pairs_2: FSharpList<[any, any]> = map_3<[string, Json_$union], [any, any]>((tupledArg_4: [string, Json_$union]): [any, any] => ([Convert_fromJsonAs(Json_JString(tupledArg_4[0]), keyType_2), Convert_fromJsonAs(tupledArg_4[1], patternInput_9[1])] as [any, any]), toList_1<string, Json_$union>(dict_2!));
            ...
            case 65: {
                    ...
                    if (value_91(matchValue_7).tag === /* JObject */ 5) {
                        if (matchValue_8 != null) {
                            switch (value_91(matchValue_8).tag) {
                                case /* JArray */ 4: {
                                    if ((tree = (value_91(matchValue_8) as Json<4>).fields[0], isEmpty_1<string, Json_$union>((value_91(matchValue_7) as Json<5>).fields[0]))) {
                                        matchResult_6 = 0;
                                ...
                                case /* JObject */ 5: {
                                    if ((tree_1 = (value_91(matchValue_8) as Json<5>).fields[0], isEmpty_1<string, Json_$union>((value_91(matchValue_7) as Json<5>).fields[0]))) {
                                        matchResult_6 = 1;
                ...
                switch (matchResult_6) {
                    case 0: {
                        ...
                        if (matchValue_10 == null) {
                            ...
                            const pairs_3: FSharpList<[any, any]> = map_3<[string, Json_$union], [any, any]>((tupledArg_5: [string, Json_$union]): [any, any] => {
                                ...
                                return [!Convert_isQuoted(key_6) ? Convert_fromJsonAs(Json_JString(key_6), keyType_3) : Convert_fromJsonAs(SimpleJson_parseNative(key_6), keyType_3), Convert_fromJsonAs(tupledArg_5[1], valueType_5)] as [any, any];
                    ...
                    case 1: {
                        input_mut = Json_JObject(ofList<string, Json_$union>(Convert_flatteFable3Map(tree_3!), {
                            Compare: comparePrimitives,
                        }));
                        typeInfo_mut = typeInfo;
                        continue Convert_fromJsonAs;
                    ...
                    default: {
                        const pairs_4: FSharpList<[string, any]> = map_3<[string, Json_$union], [string, any]>((tupledArg_6: [string, Json_$union]): [string, any] => {
                            ...
                            return [!Convert_isQuoted(key_7) ? ((isPrimitive(keyType_3) ? true : enumUnion(keyType_3)) ? Convert_fromJsonAs(Json_JString(key_7), keyType_3) : Convert_fromJsonAs(SimpleJson_parseNative(key_7), keyType_3)) : Convert_fromJsonAs(SimpleJson_parseNative(key_7), keyType_3), Convert_fromJsonAs(tupledArg_6[1], valueType_5)] as [string, any];
...
export function Convert_serialize(value_mut: any, typeInfo_mut: TypeInfo_$union): string {
    ...
    while (true) {
        ...
        switch (typeInfo.tag) {
            ...
            case /* Record */ 39:
                return ("{" + join(", ", map_2<RecordField, string>((field: RecordField): string => {
                    const arg_1: string = Convert_serialize(getRecordField(value, field.PropertyInfo), field.FieldType);
                    return toText(printf("\"%s\": %s"))(field.FieldName)(arg_1);
                }, typeInfo.fields[0]()[0]))) + "}";
            case /* ResizeArray */ 35: {
                const elementType: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_4<any, string>((element: any): string => Convert_serialize(element, elementType), value))) + "]";
            }
            case /* HashSet */ 36: {
                const elementType_1: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_4<any, string>((element_1: any): string => Convert_serialize(element_1, elementType_1), value))) + "]";
            }
            case /* Set */ 29: {
                const elementType_2: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_4<IComparable<any>, string>((element_2: IComparable<any>): string => Convert_serialize(element_2, elementType_2), value))) + "]";
            }
            case /* Array */ 30: {
                const elementType_3: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_2<any, string>((element_3: any): string => Convert_serialize(element_3, elementType_3), value))) + "]";
            }
            case /* List */ 28: {
                const elementType_4: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_3<any, string>((element_4: any): string => Convert_serialize(element_4, elementType_4), value))) + "]";
            }
            case /* Seq */ 31: {
                const elementType_5: TypeInfo_$union = typeInfo.fields[0]();
                return ("[" + join(", ", map_2<any, string>((element_5: any): string => Convert_serialize(element_5, elementType_5), toArray_1<any>(value)))) + "]";
            }
            case /* Option */ 27: {
            ...
            case /* Union */ 40: {
                const patternInput_1: [UnionCase[], any] = typeInfo.fields[0]();
                const patternInput_2: [any, any[]] = getUnionFields(value, patternInput_1[1]);
                const usedCase: any = patternInput_2[0];
                const fields: any[] = patternInput_2[1];
                const caseTypes: TypeInfo_$union[] = find_1<UnionCase>((case$: UnionCase): boolean => (case$.CaseName === name_2(usedCase)), patternInput_1[0]).CaseTypes;
            ...
            case /* Map */ 33: {
                const patternInput_3: [TypeInfo_$union, TypeInfo_$union] = typeInfo.fields[0]();
                ...
                const serializedValues: string = join(", ", map_2<[IComparable<any>, any], string>((tupledArg: [IComparable<any>, any]): string => {
                    const serializedKey: string = Convert_serialize(tupledArg[0], keyType);
                    const serializedValue: string = Convert_serialize(tupledArg[1], patternInput_3[1]);
            ...
            case /* Dictionary */ 34: {
                const patternInput_4: [TypeInfo_$union, TypeInfo_$union, any] = typeInfo.fields[0]();
                ...
                const serializedValues_1: string = join(", ", map_4<[IComparable<any>, any], string>((pair: [IComparable<any>, any]): string => {
                    const serializedKey_1: string = Convert_serialize(pair[0], keyType_1);
                    const serializedValue_1: string = Convert_serialize(pair[1], patternInput_4[1]);
            ...
            case /* Tuple */ 32: {
                const tupleTypes: TypeInfo_$union[] = typeInfo.fields[0]();
                if (tupleTypes.length === 1) {
                    return ("[" + Convert_serialize(value, item_1(0, tupleTypes))) + "]";
                }
                else {
                    return ("[" + join(", ", mapIndexed<any, string>((index_1: int32, element_6: any): string => Convert_serialize(element_6, item_1(index_1, tupleTypes)), value))) + "]";
                }
            }
            case /* Object */ 23:
