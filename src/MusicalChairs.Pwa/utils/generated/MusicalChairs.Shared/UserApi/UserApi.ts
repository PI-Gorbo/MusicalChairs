...
import { lambda_type, unit_type, union_type, record_type, array_type, string_type, class_type, TypeInfo } from "../../fable_modules/fable-library-ts.4.24.0/Reflection.js";
...
export class UserDto extends Record implements IEquatable<UserDto>, IComparable<UserDto> {
    ...
    readonly plannedJobs: string[];
    readonly jobs: string[];
    constructor(id: string, username: string, email: string, plannedJobs: string[], jobs: string[]) {
        super();
        this.id = id;
...
export function UserDto_$reflection(): TypeInfo {
    return record_type("MusicalChairs.Shared.UserApi.UserDto", [], UserDto, () => [["id", class_type("System.Guid")], ["username", string_type], ["email", string_type], ["plannedJobs", array_type(class_type("System.Guid"))], ["jobs", array_type(class_type("System.Guid"))]]);
}
...
export function RegisterFailure_$reflection(): TypeInfo {
    return union_type("MusicalChairs.Shared.UserApi.RegisterFailure", [], RegisterFailure, () => [[], [["reason", string_type]]]);
}
...
export function ResetPasswordError_$reflection(): TypeInfo {
    return union_type("MusicalChairs.Shared.UserApi.ResetPasswordError", [], ResetPasswordError, () => [[], [["error", string_type]]]);
}

export class IUserApi extends Record {
    readonly me: (() => Async<UserDto>);
